<template>
  ...
  <q-banner v-else-if="tabset?.tabs.length === 0 && tabset?.type !== TabsetType.DYNAMIC">
    To start adding new tabs to this empty tabset, open new browser tabs and come back to this extension to associate
    them with a tabset.<br /><br />
  ...
  <!--  <DynamicTabsetPageCards v-if="tabset?.type === TabsetType.DYNAMIC" :tabset="tabset as unknown as Tabset" />-->
...
import TabsetPageCards from 'src/tabsets/pages/TabsetPageCards.vue'
